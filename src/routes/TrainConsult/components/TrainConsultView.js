...
import { Button, ButtonArea, Flex, FlexItem, TextArea, Form, FormCell, CellHeader, Label, CellBody, Input } from 'react-weui'
            ...
            <div>
                <Form>
                    ...
                    <FormCell>
                        ...
                        <CellBody className="cellinput">
                            <TextArea placeholder="请输入要咨询的内容" rows="5" maxlength="200"></TextArea>
                        </CellBody>
                    </FormCell>
